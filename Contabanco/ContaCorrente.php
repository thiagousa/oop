...
class ContaCorrente implements Conta
{
    ...
    public function pagarMensal(){
        ...
        if($this->isStatus() && $this->getSaldo()>= 12){
        ...
        elseif($this->isStatus() && $this->getSaldo()< 12){


            echo "<p> Valor da conta menor 12 que o da mensalidade , Impossivel realizar a operacao de Mensalidade </p>";
